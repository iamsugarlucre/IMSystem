...
public class ChatController {
    ...
    // Send a message
    // here @MessageMapping can be regarded as @RequestMapping,
    // when there is information (sendMsg in method messageEntity The parameter is the information entity sent by the client)
    // send to /sendMsg will be processed here
    ...
    public Result sendMsg(Message message) {
        ...
        if (!message.getMessageType().equals("text")) {
            // Create attachment and store it in database
